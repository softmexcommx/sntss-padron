...
<head>
    <title>SNTSS Sección XXXVI</title>
                    ...
                    <!-- Authentication card start -->
                        ...
                        {{ csrf_field() }}
                            <div class="text-center">
                                <img style="width: 250px" src="{{ asset('images/logos/logosntss.png') }}" alt="">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Padrón Electoral</h3>
                                        </div>
                                    </div>
                                    ...
                                    @if(session('tra'))
                                    <div class="alert alert-primary alert-dismissible show text-justify" role="alert">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                       Número: <strong style="color: red;"> {!! session('tra')->numero !!} </strong>
                                        <br>
                                      Nombre:<br> <strong style="color: black;">  {!! session('tra')->Nombre2 !!} </strong>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-success btn-md btn-block waves-effect waves-light text-center m-b-20">Buscar</button>
                                        </div>
                                    </div>
                                    <hr/>
